...
from app.database.models.mentor import UserModel as UserModel_mentor
from app.database.models.mentee import UserModel as UserModel_mentee
from app.database.sqlalchemy_extension import db
from app.utils.enum_utils import MentorshipRelationState


class MentorshipModel(db.Model):
    ...
    # Specifying database table used for MentorshipModel
    ...
    mentor = db.relationship(
        ...
        primaryjoin="MentorshipModel.mentor_id == UserModel_mentor.id",
    )
    mentee = db.relationship(
        UserModel_mentee,
        backref="mentee_relations",
        primaryjoin="MentorshipModel.mentee_id == UserModel_mentee.id",
    )
    ...
    @classmethod
    def find_by_id(cls, _id) -> "MentorshipModel":
